...
public class ShopRecommendAdapter  extends ArrayAdapter<RecommendItem>   {

    private Context context;
    private int reID;
    private ArrayList<RecommendItem> recommendItems;

    public ShopRecommendAdapter(Context context, int resource, ArrayList<RecommendItem> data) {
